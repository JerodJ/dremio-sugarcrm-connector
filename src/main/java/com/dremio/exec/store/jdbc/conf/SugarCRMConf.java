...
@SourceType(value = "SugarCRMARP", label = "SugarCRM",uiConfig = "sugarcrm-layout.json")
public class SugarCRMConf extends AbstractArpConf<SugarCRMConf> {
  private static final String ARP_FILENAME = "arp/implementation/sugarcrm-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sugarcrm.SugarCRMDriver";
